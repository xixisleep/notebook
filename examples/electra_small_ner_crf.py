...
batch_size = 32
bert_layers = 12
learing_rate = 3e-4  # bert_layers越小，学习率应该要越大
crf_lr_multiplier = 1000  # 必要时扩大CRF层的学习率

#bert配置
config_path = '../config/chinese_electra_small_L-12_H-256_A-4/electra_config.json'
checkpoint_path = '../config/chinese_electra_small_L-12_H-256_A-4/electra_small'
dict_path = '../config/chinese_electra_small_L-12_H-256_A-4/vocab.txt'
labels = set()
...
class Evaluate(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if f1 >= self.best_val_f1:
            self.best_val_f1 = f1
            model.save_weights('./model/bert_ner_best_model.weights')
...
if __name__ == '__main__':
    ...
    model.load_weights('./model/bert_ner_best_model.weights')
