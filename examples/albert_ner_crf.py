...
# albert配置
config_path = '../config/albert_google_base_zh/albert_config.json'
checkpoint_path = '../config/albert_google_base_zh/model.ckpt-best'
dict_path = '../config/albert_google_base_zh/vocab_chinese.txt'
#bert配置
# config_path = '../config/chinese_L-12_H-768_A-12/bert_config.json'
# checkpoint_path = '../config/chinese_L-12_H-768_A-12/bert_model.ckpt'
# dict_path = '../config/chinese_L-12_H-768_A-12/vocab.txt'
labels = set()
