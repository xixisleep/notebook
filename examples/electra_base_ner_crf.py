...
#bert配置
config_path = '../config/chinese_electra_base_L-12_H-768_A-12/electra_config.json'
checkpoint_path = '../config/chinese_electra_base_L-12_H-768_A-12/electra_base'
dict_path = '../config/chinese_electra_base_L-12_H-768_A-12/vocab.txt'
labels = set()
...
if __name__ == '__main__':
    ...
    model.load_weights('./model/electra_base_ner_best_model.weights')
