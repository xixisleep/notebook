...
#bert配置
config_path = '../config/chinese_wwm_ext_L-12_H-768_A-12/bert_config.json'
checkpoint_path = '../config/chinese_wwm_ext_L-12_H-768_A-12/bert_model.ckpt'
dict_path = '../config/chinese_wwm_ext_L-12_H-768_A-12/vocab.txt'
labels = set()
...
class Evaluate(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if f1 >= self.best_val_f1:
            self.best_val_f1 = f1
            model.save_weights('./model/wwm_ext_ner_best_model.weights')
...
if __name__ == '__main__':
    ...
    model.load_weights('./model/wwm_ext_ner_best_model.weights')
